...
const std::string vtkSlicerRegistrationQualityLogic::TRANSFORM = "Transform";
...
const std::string vtkSlicerRegistrationQualityLogic::TRANSFORMITEMID = TRANSFORM + ITEMID;
...
bool vtkSlicerRegistrationQualityLogic
